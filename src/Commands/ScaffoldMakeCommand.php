...
namespace RaphaGodoi\ScaffoldVel\Commands;
...
use RaphaGodoi\ScaffoldVel\Makes\MakerTrait;
...
class ScaffoldMakeCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Create a scaffoldvel scaffold';
    ...
    {
        $this->stubs = $this->getStubViews($this->meta['ui']);
    }
